...
El standalone además de setearnos el proyecto, nos dispara todos los componentes en el orden correcto (se puede ver en la consola, al iniciarlo, en diferentes colores: webserver, triggerer, etc...), de hecho está hecho para eso, para usarse en fase de desarrollo, en ambientes productivos ya es recomendable usarlos separado.
