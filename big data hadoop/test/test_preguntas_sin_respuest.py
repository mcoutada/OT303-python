...
def test_reducer_empty_dict():
    """funcion reducer con dicc vacio"""
    d1 = {"a": 1, "b": 1, "c": 1}
    d2 = {}
    r = reducer(d1, d2)
...
def test_unanswered_responses(tree_node_postid2):
    """preguntas sin respuestas con idpost del data tree"""
...
def pregunts_sin_respuest(tree_node):
