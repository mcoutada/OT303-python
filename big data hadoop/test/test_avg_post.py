...
from avg_post import reducer, chunkify, gets_score_fav, mapper


"""args:
row 1 :pregunta directa del post.xml    
row 2 : respuesta en base al post.xml raw 3 : result code - pytest feature"""

@pytest.fixture
def tree_node():
    xml = """<?xml version="1.0" encoding="utf-8"?>
    <row Id="6" PostTypeId="1" CreationDate="2009-06-28T08:40:18.673" Score="5" ViewCount="249" Body="&lt;p&gt"""
...
def test_reducer_empty_dict():
    """funcion reducer con directorio vacio"""
    d1 = {2: 1, 3: 1, 4: 1}
    d2 = {}
    r = reducer(d1, d2)
...
def test_avg_post(tree_node):
    """funcion para obtener score"""
